...
function NativeSelect({
  ...
  return (
    <div
      className="group/native-select relative min-w-0 w-full has-[select:disabled]:opacity-50"
    ...
    >
      ...
      />
      <ChevronDownIcon
        className="pointer-events-none absolute top-1/2 right-3.5 size-4 -translate-y-1/2 text-ui-muted-foreground opacity-50 select-none"
        aria-hidden="true"
