  ...
  return (
    ...
    >
      <SwitchPrimitive.Thumb
        ...
        className={cn(
          "pointer-events-none block rounded-full bg-ui-background ring-0 transition-transform ui-motion-feedback group-data-[size=default]/switch:size-4 group-data-[size=sm]/switch:size-3 data-[state=checked]:translate-x-[calc(100%-2px)] data-[state=unchecked]:translate-x-0 dark:data-[state=checked]:bg-ui-primary-foreground dark:data-[state=unchecked]:bg-ui-foreground",
        )}
      />
    </SwitchPrimitive.Root>
  );
