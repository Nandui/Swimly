...
export const PARENT_GUIDES: HelpArticle[] = [
  {
    ...
    summary: "Choose exactly which guardian emails can see a swimmer in Bookly, across both sites.",
    keywords: ["parent", "guardian", "Bookly", "approve", "revoke", "restore", "email", "child access"],
    ...
    steps: [
      ...
      { title: "Tell the guardian how to sign in", text: "Approval does not send an email. The guardian opens Bookly and signs in with the approved address. They can see released progress and bookings, but no medical or internal notes. Competency changes appear the next day at midnight in Ireland." },
  ...
  },
  {
    ...
    summary: "Look up a Bookly account by its full email address and manage its sign-in access.",
    keywords: ["parent account", "Bookly", "suspend", "reactivate", "blocked", "login", "sign in"],
    ...
    steps: [
      { title: "Open Parent accounts from Swimmers", text: "Choose Parent accounts beside Add swimmer. Enter the full address used in Bookly, then choose Find account. Searches match that exact address." },
  ...
  },
  {
    ...
    summary: "Make a session available in Bookly and choose when parent booking closes.",
    keywords: ["parent", "Bookly", "publish", "unpublish", "assessment", "booking deadline", "online booking"],
    ...
    steps: [
      { title: "Open the assessment session", text: "In Assessments, open the session and check its site, date, time and places. Booking in Bookly shows its parent publication status." },
      { title: "Choose Publish to Bookly", text: "Check the session named in the dialog. Set an optional future booking deadline in Ireland time, no later than the session starts. Leave it blank to close booking at the start. Add your reason and choose Publish session." },
