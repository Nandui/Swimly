...
export const GUIDE_SCREENSHOTS: Record<string, Placement[]> = {
  "legend-agreements": [{ image: "legend-agreements", step: "Open Legend agreements", caption: "Outstanding lists each active class place that needs checking or still needs its Legend agreement updated.", alt: "Legend agreements page with fictional swimmers, class times, Needs checking and Still to do statuses, and Confirm updated actions." }],
  "assessment-enrolment-follow-up": [{ image: "assessment-awaiting-enrolment", step: "Open Awaiting enrolment", caption: "Open Awaiting enrolment from the sidebar to follow up assessment placements and class waitlists.", alt: "Standalone Awaiting enrolment page with fictional assessment and waitlist records, family contacts and enrolment actions." }],
  ...
  "start-class": [{ image: "start-class", step: "Choose Start class", caption: "Confirm that you are teaching this dated class. Other authorised instructors can also help.", alt: "Start Turtles confirmation with the class time, an explanation that the start is recorded and colleagues can also open the session, and Confirm and start." }],
  ...
  "record-competencies": [
    { image: "competencies", step: "Mark what was demonstrated", caption: "Work through one competency at a time and mark the swimmers who were in today.", alt: "Class competency checklist with a competency selector, achieved controls, a group marking action and Not in today section.", scope: "desk" },
    { image: "instructor-swimmer-competencies", step: "Mark one swimmer’s competencies", caption: "Expand a swimmer to mark their competencies individually or mark all achieved, then save the class’s changes.", alt: "Instructor competency checklist with fictional Jamie Example’s six competencies expanded, individual mark choices, Mark all achieved and Save marks.", scope: "instructor" },
    ...
    { image: "instructor-class-overview", step: "Plan teaching from the class overview", caption: "Each competency card shows how many swimmers have achieved it.", alt: "Class overview with six competency cards and fictional achievement totals.", scope: "instructor" },
    { image: "instructor-class-overview-mobile", step: "Plan teaching from the class overview", caption: "The same totals appear in two columns on phones.", alt: "Mobile class overview with competency names and achieved totals in a two-column card grid.", scope: "instructor" },
  ],
  "complete-class-level": [
    { image: "complete-class", step: "Confirm completion", caption: "Level completion has its own confirmation and optional note.", alt: "Complete Turtles dialog stating the example swimmer achieved every competency, with Note and Confirm completion.", scope: "desk" },
    { image: "instructor-swimmer-competencies", step: "Open the class’s Competencies step", caption: "Review and save every competency before confirming a swimmer is ready to move.", alt: "Instructor checklist with fictional Jamie Example’s competencies expanded, individual mark choices, Mark all achieved and Save marks.", scope: "instructor" },
  ],
  ...
  "assessment-outcome": [
    { image: "instructor-assessments", step: "Open today’s assessment", caption: "Today’s assessments appear above the weekly class filters for every instructor at this site.", alt: "Instructor home showing two fictional assessment sessions, their times, pool, assessor and booking counts, above My classes and All classes.", scope: "instructor" },
    { image: "assessment-outcome", step: "Place a swimmer who was assessed", caption: "Choose the outcome level and record what you observed.", alt: "Assessment placement dialog for an example swimmer, with level selection, Note and Place button." },
  ],
