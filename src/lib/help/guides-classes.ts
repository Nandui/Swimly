...
export const CLASS_GUIDES: HelpArticle[] = [
  ...
  },
  {
    ...
    steps: [
      { title: "Open the class’s Competencies step", text: "Check the saved marks for the swimmer. At the desk, review Ready to complete. In Instructor, expand the swimmer in By swimmer and save their achieved competencies." },
      ...
      { title: "Add a note if needed", text: "Choose Ready to move under the swimmer’s expanded competency list, then use Note for reception (optional) for relevant context. The action only appears when every competency at this level is achieved and saved for this swimmer, including swimmers whose level was already completed.", scopes: ["instructor"] },
      { title: "Confirm completion", text: "Choose Confirm completion and wait for success. The completion is recorded as its own milestone.", scopes: ["desk"] },
      { title: "Confirm ready to move", text: "Choose Confirm ready to move and wait for Awaiting move. This confirms the level completion and puts the swimmer on reception’s Awaiting moves list. They remain in the current class until reception arranges a move. Use Undo readiness if added by mistake; progress stays recorded.", scopes: ["instructor"] },
