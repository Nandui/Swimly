...
export const CLASS_GUIDES: HelpArticle[] = [
  ...
  },
  {
    ...
    summary: "Work through the class checklist, mark achievement and save your changes.", keywords: ["competency", "competencies", "skills", "achieved", "not achieved", "checklist", "marks", "assessment"],
    ...
    steps: [
      ...
      { title: "Choose the competency", text: "Use the competency selector or Previous competency and Next competency to work through the level’s checklist." },
      { title: "Mark what was demonstrated", text: "Set each swimmer’s result using the available mark choices. Use Everyone in today achieved only when that is accurate for every swimmer included." },
      ...
      { title: "Save the marks", text: "Choose Save marks and wait for confirmation. Then use Done, back to classes or the return action shown." },
