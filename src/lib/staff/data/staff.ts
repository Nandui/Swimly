...
/** The staff list. Admin tier, because who holds a key is not a thing the
 *  people holding the lesser keys need to see — and the nav never offers the
 *  route to them anyway.
 *
