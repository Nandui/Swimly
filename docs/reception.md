...
Swimmers, Classes, Schedule, Together and Assessments, according to each role's
...
use the normal fallback: Schedule when available, then their first accessible
