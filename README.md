...
The visual system is generated by the ui-ux-pro-max skill and persisted at
`design-system/swimly/MASTER.md`; that file, not the kit, is the authority for
how things look. Swimly ships **light and dark**, following the operating
system by default, with a switch on the Account page.
