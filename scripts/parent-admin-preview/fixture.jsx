...
function Screen() {
  if (screen === 'accounts') return <div className="space-y-6"><BackLink href="/?screen=directory" current="Parent accounts">Swimmers</BackLink><PageHeader title="Parent accounts" description="Find a Bookly account to check its details or manage sign-in access."/><ParentAccounts/></div>;
